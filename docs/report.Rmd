...
# get territories with different energy
d_ter = map2(
...
# TODO: resume after fixing tide_ter-*_tif-cable.csv -> tide_ter-*_tif-depth.csv for not West/Alaska
...
tbl_form_cbls = map2(
  ...
  #select(-territory) %>%
  mutate(
    depth  = factor(depth_factor, depth_labels, ordered=T),
    energy = factor(
      sprintf('%s %s', energy_factor, c(tide='W/m^2',wave='kW/m',wind='m/s')[form]),
      c(
